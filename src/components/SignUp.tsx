    ...
    return <div className='container mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[400px]'>
        <div className="flex flex-col space-y-2 text-center">
            ...
            <p className="px-8 text-center text-sm text-zinc-700">
                Already a member of CommunityHUB? <Link href="/sign-in" className="hover:text-zinc-800 text-zinc-500 text-sm font-semibold underline underline-offset-4 ">Sign In</Link>
            </p>
        </div>
    </div>
}
